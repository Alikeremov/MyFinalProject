...
namespace QuickFoodDelivery.Mvc.Areas.Manage.Controllers
{
    ...
    public class FoodCategoryController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page = 1, int take = 100)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(FdCategoryCreateVm createVm)
        {
        ...
        {
            return View(await _service.UpdatedAsync(new FdCategoryUpdateVm(), id));
        }
        [HttpPost]
        public async Task<IActionResult> Update(int id, FdCategoryUpdateVm updateVm)
        {
