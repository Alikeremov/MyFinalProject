...
namespace QuickFoodDelivery.Mvc.Areas.Manage.Controllers
{
    ...
    public class EmploymentController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(EmploymentCreateVm createVm)
        {
        ...
        {
            return View(await _service.UpdatedAsync(new EmploymentUpdateVm(), id));
        }
        [HttpPost]
        public async Task<IActionResult> Update(int id, EmploymentUpdateVm updateVm)
        {
